package com.ellenBusy;

import com.ellenBusy.dao.NewsDAO;
import com.ellenBusy.dao.UserDAO;
...
@SpringApplicationConfiguration(classes = TouTiaoForMeApplication.class)
//@WebAppConfiguration  这行会修改默认的启动路径需要注释掉
@Sql("/init-schema.sql")//创建数据库
